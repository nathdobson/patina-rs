...
const PROJECT_SETTINGS_CONFIG:&[u8]=br##"{
    ...
    "filament_settings_id": [
        ...
        "Bambu PLA Basic @BBL A1M(output.3mf)",
        "Bambu PLA Basic @BBL A1M(output.3mf)",
        "Bambu PLA Basic @BBL A1M(output.3mf)",
        "Bambu PLA Basic @BBL A1M(output.3mf)"
    ],
...
const MODEL_SETTINGS_CONFIG:&[u8]=br##"<?xml version="1.0" encoding="UTF-8"?>
<config>
  <object id="3">
    ...
    <part id="1" subtype="normal_part">
      ...
      <metadata key="matrix" value="1 0 0 15 0 1 0 15 0 0 1 15 0 0 0 1"/>
      <metadata key="source_file" value="/Users/nathan/Documents/workspace/patina/examples/flap/output.3mf"/>
      <metadata key="source_object_id" value="0"/>
      <metadata key="source_volume_id" value="0"/>
      <metadata key="source_offset_x" value="5"/>
      <metadata key="source_offset_y" value="5"/>
...
const PLATE_1:&[u8]=br##"{"bbox_all":[50.09975000000001,50.09975000000001,134.19949,121.48549000000001],"bbox_objects":[{"area":98.01673126220703,"bbox":[50.09975000000001,50.09975000000001,69.90023000000001,69.90023000000001],"id":35,"layer_height":0.20000000298023224,"name":""},{"area":98.01673126220703,"bbox":[92.80051,107.08651,134.19949,121.48549000000001],"id":1000,"layer_height":0.20000000298023224,"name":"wipe_tower"}],"bed_type":"textured_plate","filament_colors":["#0000ff","#3F8E43"],"filament_ids":[0,1],"first_extruder":0,"is_seq_print":false,"nozzle_diameter":0.4000000059604645,"version":2}"##;
...
impl ModelContainer {
    ...
    pub fn encode(&self) -> anyhow::Result<Vec<u8>> {
        ...
        if let Some(model_settings) = &self.model_settings {
            ...
            zip.write_all(MODEL_SETTINGS_CONFIG)?;
        }
        if let Some(project_settings) = &self.project_settings {
            ...
            zip.write_all(PROJECT_SETTINGS_CONFIG)?;
        }
        zip.finish()?;
        Ok(buffer)
    }
